...
import 'package:privacy_of_animal/screens/signup/signup_gender_select.dart';
import 'package:privacy_of_animal/screens/signup/signup_input.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SignUpInput(
              ...
              textInputType: TextInputType.text,
              type: FOCUS_TYPE.PROFILE_FOCUS,
              nextFocusNode: _nickNameFocusNode,
            ),
            SizedBox(height: ScreenUtil.height/25),
            _buildTitle('닉네임'),
            SignUpInput(
